...
public class PixKeyUseCaseBeansConfig {
    ...
    @Bean
    public FindPixKeyUseCase findPixKeyUseCase(com.picpay.banking.pix.core.ports.pixkey.picpay.FindPixKeyPort findPixKeyPort,
                                               FindPixKeyPort findPixKeyBacenPort) {
