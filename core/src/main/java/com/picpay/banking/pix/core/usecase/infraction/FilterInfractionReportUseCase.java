...
public class FilterInfractionReportUseCase {
    ...
    public InfractionPage execute(InfractionReportSituation situation, LocalDateTime dateStart, LocalDateTime dateEnd, int page, int size) {
        InfractionPage infractionPage = infractionReportListPort.list(situation, dateStart, dateEnd, page, size);
