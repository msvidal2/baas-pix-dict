...
class SyncVerifierTest {
    ...
    void calculateVsync_success() {
        final Stream<String> contentIdentifiers = Stream.of(
    ...
    void calculateVsyncCumulative_success() {
        var vsync = SyncVerifier.builder().build()
            .calculateVsync(Stream.of("28c06eb41c4dc9c3ae114831efcac7446c8747777fca8b145ecd31ff8480ae88"));

        vsync = SyncVerifier.builder().vsync(vsync).build()
            .calculateVsync(Stream.of("fce514f84f37934bc8aa0f861e4f7392273d71b9d18e8209d21e4192a7842058"));

        vsync = SyncVerifier.builder().vsync(vsync).build()
            .calculateVsync(Stream.of("4d4abb9168114e349672b934d16ed201a919cb49e28b7f66a240e62c92ee007f"));
    ...
    void calculate_vsync_add_remove_same_cid_one_at_time_success() {
        ...
        var vsync = SyncVerifier.builder().vsync(startVsync).build()
            .calculateVsync(Stream.of("e4bf462017a6480a906689daca85d4e4deaf0745302d39a94db034fcd5cfc437"));
        ...
        vsync = SyncVerifier.builder().vsync(vsync).build()
            .calculateVsync(Stream.of("a28919eb0499ba784b4955c0f786fe1a9918e56648659ba44db76e1615b03d4c"));

        vsync = SyncVerifier.builder().vsync(vsync).build()
            .calculateVsync(Stream.of("a28919eb0499ba784b4955c0f786fe1a9918e56648659ba44db76e1615b03d4c"));

        vsync = SyncVerifier.builder().vsync(vsync).build()
            .calculateVsync(Stream.of("f8a7a19c56239b2388a1bb7d54321877d6f2e8dfa3969e933996df6e80afe088"));
    ...
    void calculate_vsync_add_remove_same_cid_with_list_success() {
        ...
        var cids = Stream.of("e4bf462017a6480a906689daca85d4e4deaf0745302d39a94db034fcd5cfc437",
    ...
    void calculates_vsync_with_real_data_email() throws FileNotFoundException {
        ...
        String vsync = syncVerifier.calculateVsync(contentIdentifiers.stream());
