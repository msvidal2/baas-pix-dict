...
public class FailureReconciliationSyncByFileUseCaseTest {
    ...
    public void init() {
        ...
        this.failureReconciliationSyncByFileUseCase = new FailureReconciliationSyncByFileUseCase(
            bacenContentIdentifierEventsPort, databaseContentIdentifierPort, bacenPixKeyByContentIdentifierPort,
            createPixKeyPort, findPixKeyPort, removePixKeyPort, 22896431
        );
