...
class PixKeyControllerFindTest {
    ...
    void when_findAddressingKeyWithSuccess_expect_statusOk() {
        ...
        when(pixKeyJDClient.findPixKey(anyString(), anyString(), nullable(String.class), nullable(String.class)))
                .thenReturn(responseMockDTO);


        assertDoesNotThrow(() -> {
            mockMvc.perform(get("http://localhost:8080/v1/keys/joao@ppicpay.com")
