...
resource "aws_api_gateway_resource" "keys" {
  ...
  parent_id   = aws_api_gateway_rest_api.dict_api_v1.root_resource_id
  path_part   = "keys"
}

resource "aws_api_gateway_resource" "keys_key_path" {
  rest_api_id = aws_api_gateway_rest_api.dict_api.id
  parent_id   = aws_api_gateway_resource.dict_api_v1.id
  path_part   = "{key}"
}
...
resource "aws_api_gateway_integration" "keys_create" {
  rest_api_id = aws_api_gateway_rest_api.dict_api.id
  resource_id = aws_api_gateway_resource.keys_create.id
...
resource "aws_api_gateway_integration" "keys_delete" {
  rest_api_id = aws_api_gateway_rest_api.dict_api.id
  resource_id = aws_api_gateway_resource.keys_delete.id
...
resource "aws_api_gateway_integration" "keys_update" {
  rest_api_id = aws_api_gateway_rest_api.dict_api.id
  resource_id = aws_api_gateway_resource.keys_update.id
...
resource "aws_api_gateway_integration" "keys_find" {
  rest_api_id = aws_api_gateway_rest_api.dict_api.id
  resource_id = aws_api_gateway_resource.keys_find.id
...
resource "aws_api_gateway_integration" "keys_list" {
  rest_api_id = aws_api_gateway_rest_api.dict_api.id
  resource_id = aws_api_gateway_resource.keys_list.id
