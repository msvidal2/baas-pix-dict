...
public class RemovePixKeyBacenProcessor extends ProcessorTemplate<PixKeyEventData> {
    ...
    public DomainEvent<PixKeyEventData> handle(final DomainEvent<PixKeyEventData> domainEvent) {
        ...
        var pixkeyEventDataResponse = removeBacenPixKeyUseCase.execute(domainEvent.getRequestIdentifier(),
        ...
        return DomainEvent.<PixKeyEventData>builder()
                ...
                .source(PixKeyEventData.from(pixkeyEventDataResponse.toPixKey(), pixkeyEventDataResponse.getReason()))
                .requestIdentifier(pixkeyEventDataResponse.getRequestId().toString())
                .build();
    }
