...
public class InfractionReportCreateBacenProcessor implements EventProcessor<InfractionReportEventData> {
    ...
    @Override
    public void process(final DomainEvent<InfractionReportEventData> domainEvent) {
        InfractionReportEventData source = domainEvent.getSource();

        createInfractionReportUseCase.execute()
    }
