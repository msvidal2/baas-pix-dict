...
(
    ...
    last_sync_with_bacen timestamp              not null comment 'É a data em que ocorreu o ultimo sincronismo de eventos de cid. A cada sincronização esta está é atualizada com a mais recente.'
);
