...
(
    ...
    claimer_account_type character varying(4) NOT NULL,
    claimer_account_opening_date timestamp without time zone,
    claimer_type character varying(10),
    claimer_tax_id character varying(14),
    claimer_name character varying(100),
    donor_participant character varying(8),
