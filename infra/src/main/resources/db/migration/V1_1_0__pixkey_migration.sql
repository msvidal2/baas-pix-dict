...
(
    ...
    name_participant character varying(100)  NOT NULL,
    ...
    person_type character varying(14)  NOT NULL,
    tax_id character varying(14)  NOT NULL,
    name character varying(100)  NOT NULL,
    fantasy_name character varying(100)  NULL,
...
CREATE INDEX pix_key_account ON public.pix_key (branch, account_number, account_type);